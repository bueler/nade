...
# Matlab/Octave (and Python) Codes
...
## from lecture
  ...
  * [refinestable.py](assets/codes/refinestable.py) generates figures showing conditional stability for FTCS on the heat equation
