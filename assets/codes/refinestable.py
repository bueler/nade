...
# The animated .gif was generated by this use of ImageMagick:
#   $ python3 refinestable.py  # generates frame0?.png
#   $ convert -delay 300 -loop 0 frame0*.png refinestable.gif
