...
\noindent for \due{Homework}, \ee{Exams}, and \proj{Project} details.  Material covered in lecture is in black.  Classes are MWF 10:30--11:30am, Brooks 302.
...
\wkday{2}{1/23}{1/27}     & 1.3, 1.4 & 2.1, 2.2 & 2.3, 2.4 \par \hdue{A1} \, \dl{drops} \\ \hline

\wkday{3}{1/30}{2/3}      & 2.5, 2.6 \par \phantom{x} & 2.7, 2.8, 2.9 & 2.10 \\ \hline  % AWAY

\wkday{4}{2/6}{2/10}      &  & slides \vac{(no lecture)} & slides \vac{(no lecture)} \par \phantom{x} \\ \hline  % AWAY

\wkday{5}{2/13}{2/17}     & 2.12, 2.13 \par \hdue{A2} & 2.14, 2.15 \par \hdue{A3} & \\ \hline

\wkday{6}{2/20}{2/24}     & 2.16, 2.17 & 2.18, 2.21 & 3.1, 3.2 \\ \hline
