...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=blue,
    pdftitle={Syllabus for MATH F615 Spring 2023 (Bueler)},
...
\rhead{\large\sf\textbf{MATH F615 Numer.~Analysis of Diff.~Eqns., Spring 2023}}
...
\strut & \cr
{\emph{Class meeting}} & MWF 10:30--11:30 pm, Brooks 302 \cr
\strut & \cr
{\emph{CRNs}} & in-person:\, 34643 \quad online: 36848\cr
\strut & \cr
{\emph{Public website}} & \href{https://bueler.github.io/nade/}{\texttt{bueler.github.io/nade/}}\cr
\strut & \cr
{\emph{Canvas website}} & \href{https://canvas.alaska.edu/courses/13208}{\texttt{canvas.alaska.edu/courses/13208}} \cr
\strut & \cr
...
\heading{Description}
This course covers numerical approximations of partial differential equations (PDEs) and ordinary differential equations (ODEs) on computers.  PDEs are the underlying structure for fluid flow, electric/magnetic fields, thermodynamics, elastic deformation, quantum mechanics and chemistry, finance, and so on.  ODEs are even more universal, sometimes as a part of a PDE problem.  The course will include both linear and nonlinear examples.

The emphasis will be on finite difference methods for PDEs, but also on understanding ODE numerical schemes more deeply than in an undergraduate course.  We will not be satisfied with seeing pretty pictures coming from the computer.  Rather, how well do our numbers correctly approximate the intended differential equation?  We use mathematical analysis on numerical methods:  How are these methods implemented?  How are they verified and tested?  When are they stable?  Do we know in advance that they converge?
